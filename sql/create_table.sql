...
/*
增加linux_resource_history表
增加mysql_process表
增加mysql_process_killed表
*/
...
/*修改slow query的表结构并且修改表名并且增加hisrory表
-- ----------------------------
...
-- ----------------------------
-- Table structure for mysql_widget_bigtable  略有修改
-- ----------------------------
...
-- ----------------------------
-- Table structure for servers  //略有修改
-- ----------------------------
...
/*增加mysql_widget_connect
mysql_widget_hit_rate
*/
-- ----------------------------
